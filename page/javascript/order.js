...
function province_City(province_Name,city_Name,area_Name,building_Name,price_Name){
	...
	//省
	document.write('<option value="">----餐&nbsp;&nbsp;厅----</option>');	//用js输出html代码，定义下拉列表的一个选项。
	...
	//市
        ...
        document.write('<option value="">----档&nbsp;&nbsp;口----</option>');	//定义下拉列表的第一个选项，用来提示
	...
	document.write('<option value="">----品&nbsp;&nbsp;类----</option>');
	document.write('</select>');

	//楼
	document.write('<select onchange="change_Building(this)" id="building" name="'+building_Name+'">');
	document.write('<option value="">----大/小----</option>');
	document.write('</select>');

	//
	document.write(' <div>&nbsp;</div><span>应付金额:</span><br />');

	//价格
	document.write('<select id="price" class="price_tip" name="'+price_Name+'">');
//        document.write('<option></option>');
	...
	function change_Province(provinceObj){						//省份改变时调用本函数
		...
		option_Head_City.innerHTML="----档&nbsp;&nbsp;口----";
	...
	function change_City(cityObj){
		...
		option_Head_Area.innerHTML="----品&nbsp;&nbsp;类----";
	...
	function change_Area(areaObj){
		...
		option_Head_Building.innerHTML="----大/小----";
