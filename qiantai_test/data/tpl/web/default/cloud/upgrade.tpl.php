...
<ul class="nav nav-tabs">
	<li<?php  if($do == 'upgrade') { ?> class="active"<?php  } ?>><a href="<?php  echo create_url('cloud/upgrade');?>">自动更新</a></li>
	<li<?php  if($do == 'history') { ?> class="active"<?php  } ?>><a href="<?php  echo create_url('cloud/upgrade/history');?>">未成功的自动更新(需要手动更新)</a></li>
</ul>
<?php  if($do == 'upgrade') { ?>
<div class="main">
	<div style="padding:15px;">
		...
		<form action="" method="post" class="form-horizontal form" <?php  if(!$upgrade || !$upgrade['upgrade']) { ?><?php  } else { ?>onsubmit="return agreement();"<?php  } ?>>
