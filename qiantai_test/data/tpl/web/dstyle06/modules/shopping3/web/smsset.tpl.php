...
<div class="main">
	...
	<input type="hidden" name="parentid" value="<?php  echo $set['id'];?>" />
		...
		<table class="tb">
			...
			<tr>
				<th><label for="">商家订单发送开启</label></th>
				<td>
					<label for="sms_type2" class="radio inline"><input type="radio" name="sms_type" value="1" id="sms_type2"  <?php  if($set['sms_type']==1) { ?>checked="true"<?php  } ?>/>开启</label>
					&nbsp;&nbsp;&nbsp;
					<label for="sms_type1" class="radio inline"><input type="radio" name="sms_type" value="0" id="sms_type1" <?php  if($set['sms_type']==0) { ?>checked="true"<?php  } ?>/>关闭</label>
					&nbsp;&nbsp;&nbsp;
					
 					<span class="help-block">开启商家短信发送短信，此方案发送短信比较多，商家自己选择</span>
				</td>
			</tr>			
			<tr>
