...
<title><?php  if(empty($_W['setting']['copyright']['sitename'])) { ?>叶凡网络 - 微信公众平台营销管理平台 -  Powered by wxbox.cn<?php  } else { ?><?php  echo $_W['setting']['copyright']['sitename'];?><?php  } ?></title>
        <!--[if IE 7]>
            ...
            <div class="user">
                ...
                <div class="dropdown ">
                    ...
                    <ul class="dropdown-menu pull-right">
						<li>
                            <a href="./account.php?act=display&" target="mainFrame">切换账户</a>
                        </li>
						<li>
                            <a href="./account.php?act=post&id=current" target="mainFrame">编辑账户</a>
                        </li>
						<li>
        ...
        <div id="left" style="top:2px;">
			...
			<div id="footer_code">
				...
				<div class="contact-service">
					<a href="http://wpa.qq.com/msgrd?v=3&amp;uin=980642339&amp;site=qq&amp;menu=yes" target="_blank" class="" title="在线客服">
						<i class="index-icon-comments-alt"></i>在线客服
					</a>
				</div>
				<div class="contact-phone"><i class="index-icon-phone"></i>400-0551-422</div>
				<img src="/resource/haochimall/images/qrcode.jpg?v=1.3">
    ...
    <script>P.skn();</script>
 	...
 	<div style="width:100%;text-align:center;font-size:14px;color:#ff0000;display:none;">叶凡网络 v1.0</div>
	</body>
	<script>
