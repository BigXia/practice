...
<title><?php  if(empty($_W['setting']['copyright']['sitename'])) { ?>送快餐 - 微信订餐领导品牌 -  Powered by WE7.CC<?php  } else { ?><?php  echo $_W['setting']['copyright']['sitename'];?><?php  } ?></title>
<meta name="keywords" content="<?php  if(empty($_W['setting']['copyright']['keywords'])) { ?>送快餐, 微信订餐,微信餐饮<?php  } else { ?><?php  echo $_W['setting']['copyright']['keywords'];?><?php  } ?>" />
<meta name="description" content="<?php  if(empty($_W['setting']['copyright']['description'])) { ?>送快餐，微信订餐，微信餐饮。<?php  } else { ?><?php  echo $_W['setting']['copyright']['description'];?><?php  } ?>" />
...
<script type="text/javascript" src="./resource/script/require.js"></script>
