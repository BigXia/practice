        ...
        <form id="form_dish" action="<?php  echo  $this->createMobileUrl('wlorder',array('d'=>'checkout'))?>" method="post" target="hide">
            ...
            <table class="table_book">
				...
				<tr>
                    ...
                    <td colspan="2">
						<input type="text" id="text" name="address" value="<?php  echo $fans['address'];?>" placeholder="请输入您的送货地址" class="input_text" style="desplay:inline"/></td>
                </tr>
				<?php  } else { ?>
            ...
            <footer>
                ...
                <input type="button" value="立即预定" class="btn_2" id="submit_form" />
					<?php  } else { ?>
                <input type="button" value="立即预定" class="btn_2" id="submit"/>
					<?php  } ?>
				<?php  } ?>
			</footer>
        </form>
