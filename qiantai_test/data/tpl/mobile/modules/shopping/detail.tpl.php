...
<script type='text/javascript' src='./source/modules/shopping/images/touchslider.min.js'></script>
<script language='javascript' src='./source/modules/shopping/images/photoswipe/simple-inheritance.min.js'></script>
<script language='javascript' src='./source/modules/shopping/images/photoswipe/photoswipe-1.0.11.min.js'></script>
<link href="./source/modules/shopping/images/photoswipe/photoswipe.css" rel="stylesheet" />
...
<div class="detail-main" style='margin-bottom:65px;'>
	...
	<ul style="background:#FFF;">
			...
			<a href="<?php  echo $_W['attachurl'];?><?php  echo $row['attachment'];?>" rel='<?php  echo $_W['attachurl'];?><?php  echo $row['attachment'];?>'><img src="<?php  echo $_W['attachurl'];?><?php  echo $row['attachment'];?>" alt="" height="200px"/>
			</a>
		</li>
                <?php  } } ?>
		</ul>
	...
	<div class="detail-div img-rounded">
		...
		<div class="detail-group" style='margin-top:10px;'><span class="col-xs-8" style="width:100%;">
				...
				现价 : ¥ <span id='marketprice' class="text-danger" style="font-size:18px; font-weight:bold;"><?php  echo $marketprice;?></span> <?php  if(!empty($goods['unit'])) { ?>/ <?php  echo $goods['unit'];?><?php  } ?>
                        ...
                        现价 : ¥ <span class="text-danger" id='marketprice'  style="font-size:18px; font-weight:bold;"><?php  echo $marketprice;?></span> <span id='productpricecontainer' style='<?php  if($productprice<=0) { ?>display:none<?php  } ?>'>原价: <del style="font-size:16px; ">¥  <span id='productprice'><?php  echo $productprice;?></span></del></span> <?php  if(!empty($goods['unit'])) { ?>/ <?php  echo $goods['unit'];?><?php  } ?>
				...
				<span class="input-group-btn">
					<button class="btn btn-default btn-sm" type="button" onclick="addNum()"><i class="icon-plus"></i></button>
                            ...
                            <?php  if($stock!=-1) { ?>
                            <span id='stockcontainer' style="float:left;margin-left:5px;">( 剩余 <span id='stock'><?php  echo $stock;?></span> )</span>
                            <?php  } else { ?>
